...
object LearningScala1 {
  ...
  println(hello)                                  //> Hola!
  println("Guster1")                              //> Guster1
  println("Google")                               //> Google
  println("RockAround2")                          //> RockAround2
  ...
  val moreStuff = immutableHelloThere + "yeah"    //> moreStuff  : String = Hola!There!yeah
  println(moreStuff)                              //> Hola!There!yeah
  ...
  println(f"This is another example: $numberOne%06d")
                                                  //> This is another example: 000001
  ...
  val myPi: Double = 3.14159265f                  //> myPi  : Double = 3.1415927410125732
  val doublePi : Double = 2*myPi                  //> doublePi  : Double = 6.2831854820251465
  println(f"This is my doublePi: $doublePi%.3f")  //> This is my doublePi: 6.283
